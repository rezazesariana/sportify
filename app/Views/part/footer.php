...
<!-- footer ends -->
    ...
    <script src="<?= base_url('template/js/plugin.js') ?>"></script>
    <script src="<?= base_url('template/js/main.js') ?>"></script>
    <script src="<?= base_url('template/js/custom-swiper.js') ?>"></script>
    <script src="<?= base_url('template/js/custom-nav.js') ?>"></script>
    <script src="<?= base_url('template/js/custom-date.js') ?>"></script>
</body>
</html>